...
namespace SoftFluent.SocialEmailLogin
{
    public class FacebookServiceProvider : AuthServiceProvider
    {
        public FacebookServiceProvider()
        {
            ...
            ProfileUrl = "https://graph.facebook.com/v6.0/me?fields=id,name,first_name,last_name,picture,email"; // https://developers.facebook.com/docs/graph-api/reference/user
